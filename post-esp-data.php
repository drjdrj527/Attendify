...
// Associative array to map MAC addresses to names
$mac_to_name = array(
    "MAC_ADDRESS_WITHOUT_COLON" => "NAME",
    "MAC_ADDRESS_WITHOUT_COLON" => "NAME"
...
if ($_SERVER["REQUEST_METHOD"] == "POST") { // Check if the request method is POST
    ...
    if($api_key == $api_key_value) { // Check if API key matches the predefined value
        ...
        // Translate MAC address to name if it exists in the mapping
        if (isset($mac_to_name[$Name])) {
            $Name = $mac_to_name[$Name];
